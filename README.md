...
**🍿 Live preview**: https://chatgpt.minion550.me
...
More info on https://github.com/minion550/chatgpt-MVP/discussions/247.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fminion550%2Fchatgpt-MVP&env=OPENAI_API_KEY&envDescription=OpenAI%20API%20Key&envLink=https%3A%2F%2Fplatform.openai.com%2Faccount%2Fapi-keys)
...
>
> <a href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fminion550%2Fchatgpt-MVP&env=OPENAI_API_KEY&env=SITE_PASSWORD&envDescription=OpenAI%20API%20Key&envLink=https%3A%2F%2Fplatform.openai.com%2Faccount%2Fapi-keys" alt="Deploy with Vercel" target="_blank"><img src="https://vercel.com/button" alt="Deploy with Vercel" height=24 style="vertical-align: middle; margin-right: 4px;"></a>
...
[![Deploy with Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/minion550/chatgpt-MVP#OPENAI_API_KEY=&HTTPS_PROXY=&OPENAI_API_BASE_URL=&HEAD_SCRIPTS=&PUBLIC_SECRET_KEY=&OPENAI_API_MODEL=&SITE_PASSWORD=)

**Step-by-step deployment tutorial:**

1. [Fork](https://github.com/minion550/chatgpt-MVP/fork) this project，Go to [https://app.netlify.com/start](https://app.netlify.com/start) new Site, select the project you `forked` done, and connect it with your `GitHub` account.
...
Environment variables refer to the documentation below. [Docker Hub address](https://hub.docker.com/r/minion550/chatgpt-MVP).

**Direct run**
```bash
docker run --name=chatgpt-MVP -e OPENAI_API_KEY=YOUR_OPEN_API_KEY -p 3000:3000 -d minion550/chatgpt-MVP:latest
```
...
services:
  chatgpt-MVP:
    image: minion550/chatgpt-MVP:latest
    container_name: chatgpt-MVP
    restart: always
    ports:
      - '3000:3000'
    environment:
...
A: Configure environment variables `HTTPS_PROXY`，reference: https://github.com/minion550/chatgpt-MVP/issues/34

Q: throw new TypeError(${context} is not a ReadableStream.)

A: The Node version needs to be `v18` or later，reference: https://github.com/minion550/chatgpt-MVP/issues/65

Q: Accelerate domestic access without the need for proxy deployment tutorial?

A: You can refer to this tutorial: https://github.com/minion550/chatgpt-MVP/discussions/270
...
[![img](https://contributors.nn.ci/api?repo=minion550/chatgpt-MVP)](https://github.com/minion550/chatgpt-MVP/graphs/contributors)

## License

MIT © [minion550](https://github.com/minion550/chatgpt-MVP/blob/main/LICENSE)
